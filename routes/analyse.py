...
from managers.analyse import historical_analysis_manager
...
async def historical_analysis_get(request, stock):
    ...
    return await historical_analysis_manager(request, [stock], "historical_data.html", False)

@analyse.post("/historical-analysis/<stock>")
async def historical_analysis_post(request, stock):

    return await historical_analysis_manager(request, [stock], "historical_data.html")
...
async def compare_get(request, stocks):
    ...
    return await historical_analysis_manager(request, [stock1, stock2], "comparison.html", False)
...
async def compare_post(request, stocks):
    ...
    return await historical_analysis_manager(request, [stock1, stock2], "comparison.html")
